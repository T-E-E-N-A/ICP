...
### ⏱️ Time Complexity
O(n log n) — The array is sorted by end coordinates, and a single pass is made to count arrows.


### 🧠 Space Complexity
O(1) — No extra space is used beyond a few variables for tracking arrows and positions.